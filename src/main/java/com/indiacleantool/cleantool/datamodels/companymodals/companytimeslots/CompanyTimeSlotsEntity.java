package com.indiacleantool.cleantool.datamodels.companymodals.companytimeslots;
...
public class CompanyTimeSlotsEntity {
    ...
    public CompanyTimeSlotsEntity(String companyCode, String timeSlotCode, LocalDate date, LocalTime time, int availableEmployeeCount) {
    ...
    public CompanyTimeSlotsEntity(long id, String companyCode, String timeSlotCode,
                                  LocalTime time, int availableEmployeeCount) {
        this.id = id;
        this.companyCode = companyCode;
        this.timeSlotCode = timeSlotCode;
        this.time = time;
